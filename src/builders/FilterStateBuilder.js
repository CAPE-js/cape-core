...
export class FilterStateBuilder {
    ...
    static build(field) {
        switch (field.type) {
            case "text":
                return new TextFilterState(field);
            case "integer":
                return new IntegerFilterState(field);
            case "enum":
                return new EnumFilterState(field);
            case "date":
                return new DateFilterState(field);
            case "freetext":
                return new FreeTextFilterState(field);
            case "ignore":
                return false;
        }
