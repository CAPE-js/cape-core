...
import { ModeOption, typeInDebounceTextBox } from './testHelper'
...
test.describe('The homepage', () => {
  ...
  test.describe('sort', () => {
    ...
    test('sorts results', async () => {
      ...
      const summary1Text = await homePage.getSummaryCardText(0)
      const summary2Text = await homePage.getSummaryCardText(1)
